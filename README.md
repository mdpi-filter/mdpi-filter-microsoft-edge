...
- **Cell.com Author-Year Inline Citations**: On some Cell Press articles (e.g., Heliyon like [https://www.cell.com/heliyon/fulltext/S2405-8440(21)02204-0](https://www.cell.com/heliyon/fulltext/S2405-8440(21)02204-0)), author-year style inline citations (e.g., "Phan et al., 2019") that are not simple numerical links (e.g., "[1]") are not highlighted for MDPI references. Reference list highlighting and other functionalities work correctly.
